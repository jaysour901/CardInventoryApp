...
const TOPICS = [
  {
    ...
    body: [
      'BTC Set Collector is a Progressive Web App (PWA) — you can install it on your phone or desktop and use it like a native app, even offline.',
      'ON iPHONE / SAFARI:',
  ...
  },
  {
    ...
    body: [
      ...
      'HOW TO IMPORT IT:',
      '• Open a set in BTC Set Collector.',
      '• Tap "Bulk Import".',
  ...
  },
  {
    ...
    body: [
      'Import reads a BTC Set Collector export file and adds any new sets it finds into your collection.',
      'HOW TO USE IT:',
      '• Tap the Import button in the top-right of the home screen.',
      '• Choose a .json file that was exported from BTC Set Collector.',
