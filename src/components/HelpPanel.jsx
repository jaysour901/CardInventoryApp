...
const TOPICS = [
  {
    ...
    body: [
      'Card Collector is a Progressive Web App (PWA) — you can install it on your phone or desktop and use it like a native app, even offline.',
      'ON iPHONE / SAFARI:',
